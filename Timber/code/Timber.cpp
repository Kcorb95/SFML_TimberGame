...
int main()
{
	...
	// Set up the fps text
	fpsText.setFillColor(Color::White); //setFillColor(Color::White);
	...
	// Choose a color
	messageText.setFillColor(Color::White); //setFillColor(Color::White);
	scoreText.setFillColor(Color::White); //setFillColor(Color::White);
	...
	while (window.isOpen())
	{
		...
		*/
		if (!paused)
		{
			...
			// Look at all the code below that we can delete now we are using arrays
